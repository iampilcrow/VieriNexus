...
Current product version: `0.1.0.66`
...
Current workstream: version 0.1.0.66 turns Dependencies from a status report into a complete setup surface. Its content-sized cards expose every wrapped description and action without nested scrolling; missing providers can add their exact cataloged repository, refresh Dalamud, install, and load from one button, while installed disabled providers can be enabled directly. Exact filtered Dalamud Plugins and repository-settings fallbacks remain available if Dalamud rejects automatic setup. Version 0.1.0.65 remains the embedded HUD input-safety and rotation discovery hotfix.
...
- Plugin project version: `0.1.0.62`. Dalamud API 15. Version 0.1.0.62 is published through the production feed; 0.1.0.61 remains available only as an immutable historical archive.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
