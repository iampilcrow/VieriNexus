...
Current product version: `0.1.0.80`
Current published source: `0.1.0.80`, source `59932ad2395f653f57967f66df63be315f20d2d2`, website release `596c941edeb8588749627da7eb9b99a50c118ed4`, verification documentation `4b064e02d6215575ec1a4f166bcafe46b22b865c`. Release deployment `dpl_tqbV7g2Twf2nHBEuqMEc4JLDNK4A` and final documentation deployment `dpl_5L74qWTdvxqL4YhzMwonY4nD4gyz` are Ready; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `ECC32D24FC9BE992822763639A7D82C682C72FB44224AC6108D0350907312BE8` / `B7C988A3B2222E3F8FB2C37341BCE8C71F92AE6396BF4859A4AD281109B472EB`; Discord workflow `35486765981` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.80 is published and completes the per-computer settings handoff for VieriCodex One Click Navigation. Fresh preparation imports the saved enabled state, key, Ctrl/Shift/Alt modifiers, and exact-modifier policy; already-activated imports receive a one-time automatic promotion, and rollback restores the exact prior Nexus shortcut. Version 0.1.0.79 remains the behavior foundation: Custom Route Editor and the compact overlay share same-zone/cross-zone navigation over stock Lifestream and vnavmesh. The overall consolidation remains active and must continue against `VieriFeatureParity` and the predecessor behavior list rather than waiting for user-discovered omissions.
...
- `VieriNexus.Plugin.csproj` — `Dalamud.NET.Sdk/15.0.0`, version `0.1.0.80`, assembly/internal root `VieriNexus`; builds and packages the five isolated custom runtime archives.
...
- Branch: `main`.
- Current release source/implementation commit: `6bc0e58befe1379776d82e0353f3c2e47898cd65 Restore one-click map navigation parity`; publication is recorded in this current `PROJECT_STATE.md` update.
...
- Plugin project version: `0.1.0.80`. Dalamud API 15. Version 0.1.0.80 is the current production feed entry; every prior version remains an immutable historical archive.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
