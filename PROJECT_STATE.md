...
- `VieriNexus.Plugin.csproj` — `Dalamud.NET.Sdk/15.0.0`, version `0.1.0.48`, assembly/internal root `VieriNexus`.
...
There are 261 automated tests across:
...
The 0.1.0.48 release candidate passes all 261 tests plus a zero-warning full plugin build.
