...
Current product version: `0.1.0.65`
Current published source: `0.1.0.65`, source `1e8ccd9e8c368fd1f19e84f2f56c1ddddeac778b`, website release `2a824a3e4885280c5c2961c7d1bbd4a028ffc426`, verification documentation `6d21385a03955ba3e359b103d11d7d0b192e2b15`. Release deployment `dpl_8kHo8qM2ZD8kNtzd6ffEUT9RcjwH` and final documentation deployment `dpl_FphzCyRxs16jgEzwNoJEH53pJoQ7` are Ready on both canonical aliases; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `61B54F40840253C552F03D3915353DA3633E2C8CC45EE6BD1B34B89F58CEF613` / `9C2E053CAFCAD35F8767EEA88E984987D3220DEA8B41AEB6C4525652A5367950`; Discord workflow `34757222439` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.65 is the release-blocking input-safety hotfix after 0.1.0.64 loaded a migrated VieriDelvUI native mouse proxy inside Nexus and captured clicks for the game and other Dalamud windows. The embedded HUD now permanently uses normal Dalamud/ImGui input and cannot install that process-wide proxy; the embedded rotation fallback also resolves the real Dalamud host rather than its generated Nexus proxy, eliminating its provider-discovery error storm. Version 0.1.0.64 remains the broad Automation, overlay, Atlas, provider-setup, and post-load travel pass.
...
The current production line is the unified Vieri runtime. Versions 0.1.0.4 through 0.1.0.60 established transactional migration, Nexus-owned routes, progression and multi-job queueing, native gear and maintenance transactions, Progress Atlas, stock Questionable compatibility, the favorites-first Plugins page, the compact operations overlay, Fast Job Switcher integration, and correct player-facing job names. Version 0.1.0.61 packages the remaining custom Rotation, Positional, HUD, Market, and Link engines inside Nexus with isolated dependencies and settings. Versions 0.1.0.62-63 complete deterministic stock AutoDuty coexistence, overlay restoration, and verified maintenance/gear replanning. Version 0.1.0.64 unifies Automation, restores detailed Atlas and overlay parity, and hardens stock-provider setup and post-load travel. Version 0.1.0.65 makes the embedded HUD input-safe and corrects embedded-provider host discovery. VieriDeck and VieriCodex are retired runtime products; after per-computer preparation, the remaining standalone Vieri plugins can be disabled while stock Questionable and stock AutoDuty provide ordinary quest/duty mechanics.
