...
Current product version: `0.1.0.85`
Current published source: `0.1.0.85`, source `38b24637b0252356805f6863e503010637972334`, website release `54f212d149c29fce13c811d4a126cc1db10712e9`, production deployment `dpl_8QJp49QyYeznohmBaxXLxMfpsipr`. Focused live verification passed for runtime/source HTTP availability, ZIP validity, and exact SHA-256 `CD84EDA38F9D81A6DAC745B1153669AB993DD4C7617EA6F2A8C442E29DF8CD5F` / `C9AA1118C9B2087A262665E468D45C19CAC619FD4D189F9715FF0CE2C748EFF6`; Discord workflow `35509165097` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.85 corrects the remaining VieriAutoDuty overlay gear-workflow regression discovered in live 0.1.0.84 testing. Gear -> Shop for Upgrades no longer opens the Gear & Inventory page. It performs a fresh native equipment/vendor scan and opens the predecessor-style modal directly from the compact overlay, with recommended slots preselected, Recommended/Select All/Clear/Refresh controls, current and replacement details, active-EXP protection, estimated cost, the imported protected gil reserve, Start Shopping, and Cancel. Start Shopping enters the same corrected Nexus-owned gear transaction used by Current Job Automation. Version 0.1.0.84's complete maintenance sequence, detailed Atlas/Hunting Log presentation, ground-only short vendor approaches, pathfinding timeout/fallback, effective automatic-buy/equip/repair controls, and one-time stock AutoDuty presentation synchronization remain intact. The overall consolidation remains subject to the non-negotiable source-to-source parity gate below.
