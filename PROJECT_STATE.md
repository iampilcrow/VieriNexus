...
- Plugin project version: `0.1.0.72`. Dalamud API 15. Version 0.1.0.72 is the current production feed entry; every prior version remains an immutable historical archive.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
