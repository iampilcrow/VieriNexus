...
Current published source: `0.1.0.76`, source `2ef1ed4d0fdc953dfa0d11ae1da268825245cec1`, website release `dc296b4c3576b400b17907ea0679c3b1f9de9d11`, verification documentation `304140d38546efc0c4a799b9d5fa8a5c96578929`. Release deployment `dpl_FBUaeSPrc2aHZa2ggHriqtb8TgW6` and final documentation deployment `dpl_GNgQx6zMpnmsXDgqtSj4ZKH4bcnK` are Ready; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `617C29031B1EB6189F865EAF0D22A721B9BFBB64865A510EC5AA61C0465D3054` / `A4D2D555EFBBE8EF1BC0255D04C3DB78AB8A454061A776ECE4350AA3813FA422`; Discord workflow `34807867251` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.76 is published and completes VieriCodex achievement-execution parity inside **Automation > World Progression** and **Progress Atlas > Achievements**. Exact stock-Questionable quest chains, Nexus-owned class/Grand Company Hunting Logs, exploration, and flying steps are automatic; supported Atlas entries have direct **Pursue** actions. Each underlying action retains its existing lease, Stop, provider-inactivity, and exact live-completion boundary. Genuinely manual/group/crafting/gathering/PvP/collection/duty-finder-only/time-gated objectives remain guided because neither Nexus nor VieriCodex can truthfully execute them unattended. The next focused gate is one ordinary in-game confirmation of a currently available quest- or Hunting-Log-backed achievement step.
...
- Branch: `main`.
- Current release source/implementation commit: `58ed9df19c4c3d84ae71aa3c8089b3d5c4dbf008 Resume gear trips after teleport`; publication is recorded in this current `PROJECT_STATE.md` update.
