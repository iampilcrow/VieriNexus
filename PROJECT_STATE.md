...
Current product version: `0.1.0.67`
Current published source: `0.1.0.67`, source `002f63c55f3ded8fc9a6a22d4f581b9136263e4c`, website release `a9f1e57a4da09127ec2c1a82adeaba6f7ab5d580`, verification documentation `aaeca2dd7ceeb5bc937527eaf7479f3604af3d7e`. Release deployment `dpl_5KtJpMTsBnU8dqGcT141wijZxQm5` and final documentation deployment `dpl_DwuHAhQ1JjxA3hgM15k1VTsYGKVm` are Ready on both canonical aliases; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `5E7D964F2A66F357111077B6C75600EE747C7F8004EC63692DF8E69C69B6946B` / `A3C0CC839520936F4C0DB45EE54C865D9C4B998931321620183543AE8A3E2E27`; Discord workflow `34761275834` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.67 removes duplicate Combat and Duty presentation. Vieri rotation suggestions and switch configuration render directly inside Nexus Combat, every legacy embedded settings path returns there, and stock Wrath remains the only rotation/action-hook provider. Nexus continuously disables stock AutoDuty's overlay and selects Wrath for its rotation integration, leaving the Nexus operations overlay as the single duty-control surface. Version 0.1.0.66 remains the complete direct dependency-setup release.
...
- `VieriNexus.Plugin.csproj` — `Dalamud.NET.Sdk/15.0.0`, version `0.1.0.67`, assembly/internal root `VieriNexus`; builds and packages the five isolated custom runtime archives.
...
- Plugin project version: `0.1.0.67`. Dalamud API 15. Version 0.1.0.66 is the currently published production feed entry while 0.1.0.67 is being released; every prior version remains an immutable historical archive.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
