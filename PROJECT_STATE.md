...
Current product version: `0.1.0.40` (release candidate)
Current published release source: `0.1.0.39`, commit `1b2cbc100b933ee41848ae5a247515b10a846cd9`. Version 0.1.0.40 adds the complete ordinary general side-quest lane and is being prepared for publication. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
...
- Plugin project version: `0.1.0.40`. Dalamud API 15. This version is the current release candidate; 0.1.0.39 remains published until the release process completes.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
