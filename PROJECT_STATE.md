...
- Branch: `main`.
- Current release source/implementation commit: `4caf39d7f946284982b8a7a34e4e9d1dde61d2ee Restore VieriAutoDuty overlay parity`; publication is recorded in this current `PROJECT_STATE.md` update.
