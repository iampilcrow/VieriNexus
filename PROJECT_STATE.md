...
Current published source: `0.1.0.60`, source `9ab70eaa8e00ae7866738432b3f97e8d3521428e`, website release `5adaeb22669132e8d6205b90aead0221db644189`, verification documentation `4642e9b58d91168e1cf49d3c13764e00873a13ec`; `0.1.0.61` is the verified local consolidation release candidate. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
...
- Plugin project version: `0.1.0.61`. Dalamud API 15. Version 0.1.0.60 remains published through the production feed until the 0.1.0.61 release completes.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
