...
Current product version: `0.1.0.84`
Current published source: `0.1.0.84`, source `21726a8563b0581df0fba3b52cf1f53cd08d49cc`, website release `0300ef92c81d8a89ebc47fb43f09e2c6202c7897`, production deployment `dpl_FbYmy2B8ssoZmivihYfb2ksbUqCa`. Focused live verification passed for runtime/source HTTP availability, ZIP validity, and exact SHA-256 `2DEB8C60FFF13D2C4A05AEFFA9F459E1D4B49B80B500F2F94F4563D010537EA6` / `5BD78A968F9491BF059159F0247DA03F69953A1C2BA05F496FB4A3DA4255E2E4`; Discord workflow `35508620540` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.84 completes a broad VieriAutoDuty-operations and VieriCodex-Atlas parity pass while keeping stock AutoDuty and Questionable as the ordinary mechanics providers. Nexus now schedules the imported repair, extraction, desynthesis, Armoire, Glamour Dresser, Triple Triad, minion, orchestrion, coffer, selling, Grand Company, and return-to-inn actions around a bounded stock AutoDuty run; exposes their original thresholds, filters, vendor choices, and toggles; and honors the automatic-buy, automatic-equip, and repair-threshold controls at runtime. The compact overlay retains the predecessor ordering and direct one-click actions. The Progress Atlas restores expansion/category hierarchy, detailed achievement and Hunting Log requirements, live completion/prerequisite state, direct pursuit, and game-detail actions. The shared gear-shopping/duty-preflight stall is corrected by preserving VieriAutoDuty's ground-only rule for short vendor approaches and by cancelling any vnavmesh path calculation that exceeds fifteen seconds, retrying a flight leg once on the ground. Stock AutoDuty's optional overlay/Wrath settings are now applied once per provider load instead of being polled and rewritten continuously. Exact gear transaction and route-state diagnostics are retained without exposing provider chatter in the overlay. The overall consolidation remains subject to the non-negotiable source-to-source parity gate below.
