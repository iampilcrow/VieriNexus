...
Current product version: `0.1.0.83` (release in progress)
Current published source: `0.1.0.82`, source `6cfcdd8eb1a567772e450af10f59fe24de05d781`, website release `979d1f58da9ae1f8caaf837b936218d01f583335`, verification documentation `9cdd600e6a3197018a5daea0a3a199ce7d7fa345`. Release deployment `6549219654` and final documentation deployment `6549244849` are successful; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `7D998B12E20F5BE70312BFF4279FD73F9E3C3D4FDE981EA750161A3BECAA008E` / `0EDFB336ADF50AC0F22457A691B73C9A1F49E63F45E8E395F2142D5FE3EAC943`; Discord workflow `35490385446` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.83 restores the literal VieriAutoDuty compact-overlay presentation boundary and one-click Sell Inventory behavior over stock providers. The overlay no longer inherits the Nexus window theme, no longer shows provider/debug completion sentences, no longer opens an approval modal, and uses the predecessor's five-pixel control spacing and bright-green bounded action line. Sell Inventory snapshots the same protected eligible items internally, discovers ordinary live-data shop NPCs, travels, interacts, selects the correct shop entry, and verifies each sale without asking the player to open a shop. Stock AutoDuty configuration now uses its current nested public keys for the hidden provider overlay and Wrath Combo selection. The overall consolidation remains active and must continue against the predecessor implementations rather than waiting for user-discovered omissions.
