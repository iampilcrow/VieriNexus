...
Working snapshot: 2026-09-19 (America/New_York)
Repository: `D:\FFXIV Plugins\VieriNexus`  
Current product version: `0.1.0.81`
Current published source: `0.1.0.81`, source `f38bdadcc341f998b77cafdd87bea0f2d0a3c740`, website release `17ee74f4403770fac47756860bcbe67e42782f5a`, verification documentation `d62c70161fe5d2b71ead6d7d23d6cb35d2f727a3`. Release deployment `dpl_Br3JoDHyCKy5Kby4gk9Wz7aBw71g` and final documentation deployment `dpl_4YUMe5qefDa29STCH83Yktq9iNkW` are Ready; focused live verification passed for runtime/source ZIP validity and exact SHA-256 `8349EE363A7767F9CB9E3234516DF0F08A39245F680435AD986284C8800A9EB6` / `F3B38BBA18B1D04ABEDEA5F7BF7EE41FDD7BB907515987B15359C6A210DFEA30`; Discord workflow `35488849643` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.81 is published and restores destination-aware arrival selection for every cross-zone saved route and One Click Navigation request. Nexus ranks current unlocked Aetherytes and Aethernet shards against the actual destination, rejects locked or hubless endpoints, and then hands the selected route to stock Lifestream and vnavmesh. Version 0.1.0.80 completed the feature's transactional shortcut import, automatic promotion, and rollback. The overall consolidation remains active and must continue against `VieriFeatureParity` and the predecessor behavior list rather than waiting for user-discovered omissions.
