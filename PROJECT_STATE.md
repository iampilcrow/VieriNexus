...
Current product version: `0.1.0.86`
Current published source: `0.1.0.86`, source `49a710ba55b362890d8c12436fb3e052b6d54a87`, website release `a4c8a971deb6f135be9fc2a9424da973892716e7`, production deployment `dpl_C2esiUPyVopyRNXkXSQRWKZfS7BM`. Focused live verification passed for runtime/source HTTP availability, ZIP validity, and exact SHA-256 `DAD8C428508A4B6B1C8BC8AC89603177545759D838AEE6B99D1EF912523F70E0` / `A9B23037546ADCDA995C470604BC49848C106F11322D3618CD3D612AC453FCA4`; Discord workflow `35510213572` succeeded. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.86 corrects the overlay gear-workflow regression from 0.1.0.85. Gear -> Shop for Upgrades is a true one-click action again: Nexus performs a fresh native equipment/vendor scan, selects only strict recommended upgrades, protects active EXP equipment, enforces the imported per-character gil reserve, and immediately starts the same corrected Nexus-owned gear transaction used by Current Job Automation. It does not open the Gear & Inventory page, a review window, or a second Start Shopping confirmation. The compact overlay reports only a concise result when there is nothing eligible to buy or the transaction cannot start. Version 0.1.0.84's complete maintenance sequence, detailed Atlas/Hunting Log presentation, ground-only short vendor approaches, pathfinding timeout/fallback, effective automatic-buy/equip/repair controls, and one-time stock AutoDuty presentation synchronization remain intact. The overall consolidation remains subject to the non-negotiable source-to-source parity gate below.

### Non-negotiable predecessor parity completion gate

No Vieri predecessor may be described as fully integrated or ready to retire merely because Nexus has a page or a partial implementation bearing the same feature name. For VieriAutoDuty, VieriCodex, VieriDeck, VieriNavPlotter, VieriRotationHelper, VieriDelvUI, VieriAvarice, VieriAutoMarket, and VieriLink, completion requires a source-to-source audit that preserves every user-facing feature, setting, data field, category, ordering rule, status/completion display, prerequisite explanation, drill-down, hotkey, direct action, one-shot action, and persisted behavior. The predecessor is the behavioral and presentation baseline. A stock plugin may own only the ordinary mechanics it actually exposes through a stable public contract; all Vieri-specific behavior and presentation remain Nexus-owned. Reduced summaries, generic launch buttons, provider/debug wording, extra approval steps, or omitted catalog depth do not satisfy parity. The Progress Atlas specifically must preserve VieriCodex's complete achievement and activity catalog, names, descriptions, prerequisites, completion state, expansion/category organization, drill-down, and one-shot execution wherever VieriCodex supported it.
...
- `Configuration.cs` — schema 11 global presentation/setup/operations-overlay settings, One Click Navigation shortcut, imported-operations preference receipt, character-scoped safety, Progression draft, complete multi-job queue state, saved Atlas/World Progression selections, one-time verified queue promotion, per-source migration state, and independent embedded-module enablement.
- `VieriNexus.Plugin.csproj` — `Dalamud.NET.Sdk/15.0.0`, version `0.1.0.81`, assembly/internal root `VieriNexus`; builds and packages the five isolated custom runtime archives.
...
- `Services/MapClickNavigationService.cs` — Nexus-owned One Click Navigation lifecycle: next-map-click arming, current-flag travel, optional shortcut capture, status/destination presentation, and Stop over the shared stock-Lifestream/vnavmesh route coordinator.
...
There are 396 automated Nexus tests across the application/domain policies, including native queue import/normalization/order/method behavior, MSQ planning/execution priority, world-automation and achievement-type selection, null-safe complete VieriCodex settings import, transactional recovery/rollback, command aliases including `job.switch`, public-version alignment, payload bounds, character scoping, rejected unsafe controls, provider identity handoff coverage, Plugins-page grouping/command behavior, maintenance ordering and thresholds, and short-vendor ground-routing/fallback behavior. The five packaged engines retain their own focused regression suites, and the release package has a separate nested-archive safety/completeness verifier.
...
- Branch: `main`.
- Current release source/implementation commit: `f38bdadcc341f998b77cafdd87bea0f2d0a3c740 Choose the nearest route arrival endpoint`; publication is recorded in this current `PROJECT_STATE.md` update.
...
- Plugin project version: `0.1.0.81`. Dalamud API 15. Version 0.1.0.81 is the current production feed entry; every prior version remains an immutable historical archive.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
...
Verification evidence for 0.1.0.62: Nexus source `0fe107f489c7202ba2f4478c2ce30860c61a59cd`, Daily Pilcrow release `f97021ad015ed773452cfb0fa27378664460400a`, and final Daily Pilcrow verification documentation `0e9740a46ae2dbf24fc25571e79f50d9890703ee` are pushed. All 325 Nexus tests, 12 embedded DelvUI tests, 21 embedded VieriLink tests, the complete Release build, the five-archive package verifier, all 205 website tests, typecheck, the thirteen-entry inventory guard, production build, and focused local/live package validation pass. Release deployment `dpl_3X5PACdg9beBk4Gq5vQohJHcNVY2` and final documentation deployment `dpl_LVZGZpxEFT4z65ffTWYcVwGfiNJ5` are Ready. The live feed advertises VieriNexus 0.1.0.62 exactly once; public runtime/source downloads return HTTP 200 as valid ZIPs and match SHA-256 `CB462B0D16CE01DFD4E6F840F1E18CCC8A12B4ABD20993C5C7298F73F862A31F` / `46E08FD1D94FCC99E42151B2785923D353A737AB8552A340C1366E8081F2C2F3`. GitHub Actions Discord workflow `34738730599` completed successfully. The focused user-side gate is to open Plugins with stock AutoDuty loaded and confirm the restored overlay category choices and clean idle status.

Verification evidence for 0.1.0.63: Nexus source `2c4e3f30dbc13266f7790e3eabbecb514688e661`, Daily Pilcrow release `35816c8b3d74a73d4e5b5cd81b745f48f0757329`, and final Daily Pilcrow verification documentation `ae1e27f01681a57961bbc605866511978f691fa6` are pushed. All 330 Nexus tests, 12 embedded DelvUI tests, 21 embedded VieriLink tests, the Release build, five-archive package verifier, all 205 website tests, typecheck, thirteen-entry inventory guard, production build, and focused local/live package validation pass; the packaging rebuild reports only 24 inherited embedded-engine warnings. Release deployment `dpl_DcKfzuiQA54d3CN7FgSLSLvy2hHb` and final documentation deployment `dpl_2dw1BEjAREoUzQ9AdF7mz3MM2rJL` are Ready on both canonical aliases. The live feed advertises VieriNexus 0.1.0.63 exactly once; public runtime/source downloads return HTTP 200 as valid ZIPs and match SHA-256 `E3A7B4C8C47D1727CB5D86C9ABC2FF7BE3A37885986AAA6133622FCF989CD928` / `E5C5D50FE51C1BCF5EB29AB4B3B244F52A97E24E6F89D6AB5AA0E74A419FFDB6`. GitHub Actions Discord workflow `34739752795` completed successfully. Stock AutoDuty is now the only executable duty candidate; one natural Progression completion should be observed continuing through any enabled Nexus maintenance and gear checks before the next activity.

Verification evidence for 0.1.0.65: after updating to 0.1.0.64, the user reported that the game and Dalamud windows could no longer be clicked or moved. The live log proved the embedded HUD installed VieriDelvUI's native FFXIV window-procedure hook after importing a configuration with special mouse handling enabled; the same log also showed the embedded Wrath fallback repeatedly resolving plugins through the generated `DispatchProxyTypes.VieriNexus` assembly. Source `1e8ccd9e8c368fd1f19e84f2f56c1ddddeac778b` permanently rejects the native proxy only in the Nexus-hosted HUD and resolves the real Dalamud host assembly for fallback provider reflection. All 331 Nexus tests, 16 embedded DelvUI tests, 21 embedded VieriLink tests, focused rotation suites, the complete Release build, five-archive package verifier, all 205 website tests, typecheck, thirteen-entry inventory guard, production build, and focused local/live package validation pass; packaging retains only the 24 inherited embedded-engine warnings. Daily Pilcrow release `2a824a3e4885280c5c2961c7d1bbd4a028ffc426` is live in deployment `dpl_8kHo8qM2ZD8kNtzd6ffEUT9RcjwH`, Ready on both canonical aliases. The live feed advertises 0.1.0.65 exactly once; both public archives return HTTP 200 as valid ZIPs and match SHA-256 `61B54F40840253C552F03D3915353DA3633E2C8CC45EE6BD1B34B89F58CEF613` / `9C2E053CAFCAD35F8767EEA88E984987D3220DEA8B41AEB6C4525652A5367950`. Discord workflow `34757222439` succeeded. Because 0.1.0.64 already replaced the process window procedure, the affected live process requires one restart; after restart/update, the focused user-side gate is to confirm the Plugin Installer and another Dalamud window remain clickable and draggable while Nexus HUD is enabled.

Verification evidence for 0.1.0.66: source `fd919d54fcc1f62db498162045ad33ea52b729b4`, Daily Pilcrow release `65300818dfa6783376ab775e4ad692e9842eb852`, and Daily Pilcrow verification documentation `97ed8dc0175cb0c202b96d817eb5938dcdbd44bf` are pushed. Dependencies now uses content-sized cards and full-width direct actions; missing cataloged providers can add or enable their exact repository, refresh Dalamud, install, and load, while installed disabled providers activate through the current profile. Exact filtered installer and repository-settings fallbacks remain visible. All 331 Nexus tests, the complete Release build, five-archive verifier, all 205 website tests, typecheck, thirteen-entry inventory guard, production build, and focused local/live package validation pass; packaging reports only the 24 inherited embedded-engine warnings. Release deployment `dpl_DhdAJSE7aWMiJwyMkcN5Y433FgQL` and final documentation deployment `dpl_2Bs461bZp5QaJS7uHBWjTPj2L72V` are Ready on both canonical aliases. The live feed advertises 0.1.0.66 exactly once; runtime/source archives return HTTP 200 as valid ZIPs and match SHA-256 `1C3B724BEC578462FDBB81EAFA542552B28B7D217E628A34A8F2CBC296921790` / `A363438837DA2AEB04BB359ADC3932D7D0815031A95667B58703600C8DBCB802`. Discord workflow `34758761814` succeeded. The focused in-game gate is one direct Enable or Install action and confirmation that the resulting card is Ready and unclipped.

Verification evidence for 0.1.0.67: source `002f63c55f3ded8fc9a6a22d4f581b9136263e4c`, Daily Pilcrow release `a9f1e57a4da09127ec2c1a82adeaba6f7ab5d580`, and Daily Pilcrow verification documentation `aaeca2d66fe84e5ccb8b2a82fafc1f2298e550a5` are pushed. Combat now renders the complete Vieri suggestion and switch configuration inline, and the embedded command, settings hotkey, and switch Configure path navigate back to Nexus instead of opening predecessor windows. Stock Wrath remains the single rotation/action-hook engine. Nexus continuously disables stock AutoDuty's overlay and selects Wrath for its integration, leaving the Nexus operations overlay as the single duty-control presentation. All 331 Nexus tests, 70 positional checks, 21 prediction checks, 1,544 rotation visual/hotkey checks, 15 window-keybind checks, the complete Release build, five-archive verifier, all 205 website tests, typecheck, thirteen-entry inventory guard, production build, and focused local/live package validation pass; packaging reports only the 24 inherited embedded-engine warnings. Release deployment `dpl_5KtJpMTsBnU8dqGcT141wijZxQm5` and final documentation deployment `dpl_DwuHAhQ1JjxA3hgM15k1VTsYGKVm` are Ready on both canonical aliases. The live feed advertises 0.1.0.67 exactly once; runtime/source archives return HTTP 200 as valid ZIPs and match SHA-256 `5E7D964F2A66F357111077B6C75600EE747C7F8004EC63692DF8E69C69B6946B` / `A3C0CC839520936F4C0DB45EE54C865D9C4B998931321620183543AE8A3E2E27`. Discord workflow `34761275834` succeeded. The focused in-game gate is to confirm Combat settings remain inline and only the Nexus duty overlay is visible while stock AutoDuty is ready.
...
Verification evidence for 0.1.0.69: source `d7a454b1b6cc7e8d23dde6a5868a07bfb76cbade`, Daily Pilcrow release `6b14409b8e62984338373733392e3875ac207117`, and verification documentation `969bb9dde6b34dd00ead2c863ac4240af4683ca0` are pushed. The renamed Automation/module labels and centered transparent Home presentation are implemented without changing persisted page identifiers. The navigation width scales to protect Custom Route Editor from clipping. A stock AutoDuty instance whose shared channels were released by a later VieriAutoDuty unload is now reported as **Restart required** with the exact one-time recovery, never as a compatible executable provider. All 332 Nexus tests, the complete Release build, five-module package verifier, all 205 website tests, typecheck, production build, and focused local/live validation pass. Release deployment `dpl_Ca5PDoC3Ps9xxxm4ZBHef2RbH89c` and final documentation deployment `dpl_6owdpdovfwqP64uoj6HobY27W3Kz` are Ready on both canonical aliases. Runtime/source SHA-256: `0EAB376CF88ACD808B5501E48A46B4C27CBCF17C6959DA0290CBA8EFC16EE86B` / `B4D31DBECBFBB920BAE067E65DDB885DE303B99993268FAEFD7E40075E966F8D`. Discord workflow `34764315848` succeeded.

Verification evidence for 0.1.0.70: source `72aeaf563024569e2ec52e6556499c1d404da21a`, Daily Pilcrow release `09e1bf61d6a8632a983a3ca3989e82cd8b5e406a`, and verification documentation `cff22ff26a41bd8adc0721aa40a6ba74d7d8e07c` are pushed. Exact stock AutoDuty identity is enforced for installed discovery, catalog installation, and enabling, so VieriAutoDuty can no longer satisfy or receive those setup actions. New configurations use 70% main-window opacity with a persistent 35%-100% Appearance control while foreground text remains fully opaque. All 335 Nexus tests, the complete Release build, five-module package verifier, all 205 website tests, typecheck, production build, and focused local/live validation pass. Release deployment `dpl_8aVx7CKmDUDxiPExVVFSFvD5JNUZ` and final documentation deployment `dpl_5DHMSbsjt6XUu5PvDz6Cc9Ax7Gzy` are Ready on both canonical aliases. The public runtime/source ZIPs return HTTP 200, are valid, and match SHA-256 `9C96C1F24F5F93BE9988918712B68816D15BD65AE670BB9242B2B1266D157036` / `18A4B0B41FFD6B65684B3C147E25A86B9A2F31F213DA912DF2F4594B83FF1D9C`. Discord workflow `34767084412` succeeded.

Verification evidence for 0.1.0.71: source `f0af6dc90fb293d22ea41bc248805adb15fa5fb6`, Daily Pilcrow release `1590d57693952b02cd58f2239054133bb10e2046`, and verification documentation `95c39bd8c47ed8b4ffb630b279d8cc65486d9262` are pushed. Nexus detects the VieriAutoDuty/stock AutoDuty shared-identity collision proven by the live Dalamud cleanup log, provides exact stock settings access, automatically hands Current Job Automation off from an active or paused Multi-Job queue, consolidates its configuration and Start UI, and keeps native gear transactions alive across teleport loading screens. Coordinated VieriAutoDuty 1.0.0.444 source `d993fc979350dc8ac83c733cee56314c19e0d01d` replaces inherited AutoDuty gallery screenshots with the standard Vieri logo. All 336 Nexus tests, 342 VieriAutoDuty tests, both Release builds, the five-module package verifier, all 205 website tests, typecheck, production build, and focused local/live validation pass. Release deployment `dpl_4VNZbi4LufXqqFKXSnuhrRxMfq2C` and final documentation deployment `dpl_2QQRGQbzBU9XkrYThbNRjS4ji4jt` are Ready on both canonical aliases. Nexus runtime/source SHA-256: `7AE5B174271E9DC27A92677892684A939729936AE482874237E2BC24458B0B4A` / `D7C45253AE5A273105F0AD5CEB74AD4A3888F42E7BFFDFF1AB786B1CA5D35D08`. VieriAutoDuty runtime/source SHA-256: `6C4C3600AE6500C38CD5FAB1991CB02E284DACB10247C040FD68B7FDC250773D` / `CA073A57158108046F47B65F41958A610FF14F5D245D4563615D9EE6977392C0`. Discord workflow `34769679019` succeeded.

Verification evidence for 0.1.0.72: source `dad78d48e9b7e889cf170c6ba8de61cdb87ee1fd`, Daily Pilcrow release `ac28bef0d56e5aa5c969df293f094235688fce79`, and verification documentation `8c58ad6d116ee60d0aa49c6beb0c7f50d7d71aeb` are pushed. The live startup log proved Dalamud processed VieriAutoDuty's scheduled deletion and then removed stock AutoDuty 0.0.0.335 as the older version in their shared package folder. Nexus now detects the residual queued-removal manifest, reports Restart required, and blocks stock installation until after that cleanup restart. All 336 Nexus tests, the complete Release build, five-module verifier, all 205 website tests, typecheck, production build, focused validation, and public HTTP/ZIP/hash checks pass. Release deployment `dpl_7MWbFUHyY5uTBTD5JWpYzvVNjorQ` and final documentation deployment `dpl_83S7PMacLgtG3UfbJQZVuipNdBN4` are Ready on both canonical aliases. Runtime/source SHA-256: `EEB6DF36FFE75AC79993A621797D43B632B01AC376AE19478C8FF20AB5522F66` / `24C0FD667FF263439593E2F063F93192E119F42DC49EFB98AC2A11D56AC8060D`. Discord workflow `34771965245` succeeded.

Verification evidence for 0.1.0.73: source `4caf39d7f946284982b8a7a34e4e9d1dde61d2ee`, Daily Pilcrow release `ac1febc7bae24972df41c4a9451c2dcc7ccc2976`, and verification documentation `1b6e25a33e54e3f0371622aae981064198c7c807` are pushed. The compact Nexus operations overlay now follows the standalone VieriAutoDuty row and original menu organization. Sell Inventory, Equip, TurnIn, Coffers, Armoire, and Triple Triad registration/selling are restored; unrelated page navigation and maintenance choices are removed. Protected selling requires an exact in-overlay preview and single-use approval. All 336 Nexus tests, the complete Release build, five-module verifier, all 205 website tests, typecheck, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. Release deployment `dpl_7MfRfBBZUcFQ9j7Uuc77DxTP2nGY` and final documentation deployment `dpl_5KY46Qh2LvSjdxxTc7yZ6DziFg9g` are Ready. Runtime/source SHA-256: `38BFED59AF6D670D03D5271A34C0C248406F6BF7080818962EE1367740E82BB1` / `B35B95FF900BF921DE7F32C4D001D303EECCC966548D46784BC80FEEB498B1C1`. Discord workflow `34773373234` succeeded.

Verification evidence for 0.1.0.74: source `58ed9df19c4c3d84ae71aa3c8089b3d5c4dbf008`, Daily Pilcrow release `c6dc288a007a39384867ed3f97b7bdb478879a74`, and verification documentation `111c8d4` are pushed. Manual and queued gear-shopping trips use the same corrected destination-arrival policy: an exact loaded vendor territory completes the Lifestream leg even if its busy flag lingers, Nexus releases that completed provider state, waits only for the destination mesh, and begins local vendor movement without another click. Six focused arrival-policy regressions pass alongside all 342 Nexus tests, the complete Release build, five-module verifier, all 205 website tests, typecheck, production build, focused local/live validation, and public HTTP/ZIP/hash checks. Release deployment `dpl_9RoN3noVS7hctiviCS7XZk69F8AD` and final documentation deployment `dpl_2Ge1v4VrZQaMXw2swURiZunA4qCe` are Ready on both canonical aliases. Runtime/source SHA-256: `8718A9F4F51F0946E775E6011977900C355C4920F8B0D84F081C72DE37FEBE44` / `0F2254924C21FC172E108D141D7BE935CC1E6CEEC6EDA8CDDC9A437120F1DE9F`. Discord workflow `34794022347` succeeded.

Verification evidence for 0.1.0.75: source `0bbf2edfd527f576ee0a06d0e4463d6e50898441`, Daily Pilcrow release `27e54f53746b0519bab13f4370750c9462a63470`, and verification documentation `1b668e4` are pushed. Automation now includes the native World Progression mode for Aetherytes/Aethernet, field and quest Aether Currents, world exploration, and directly supported achievement goals. It schedules one exact action, observes structured completion, and replans without replaying stopped or failed work; Current Job, Multi-Job, and World Progression modes hand off exclusive automation ownership. All 344 Nexus tests, the complete Release build, five-module verifier, all 205 website tests, typecheck, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. Release deployment `dpl_AN1rt4oxBJB66Sh35V1B5hsMTekW` and final documentation deployment `dpl_BSSfTYDS1x12BGJy94LC4awHtcyo` are Ready. Runtime/source SHA-256: `94996DD532B1D4AA0005A1876AD3E1229AF9314514E92044BC5B92DC4A26A8F3` / `07D805D5E12F7362936E7C2D0300D868CD52409D8E51047889D4A2C68AAFA0ED`. Discord workflow `34803658042` succeeded.

Verification evidence for 0.1.0.76: source `2ef1ed4d0fdc953dfa0d11ae1da268825245cec1`, Daily Pilcrow release `dc296b4c3576b400b17907ea0679c3b1f9de9d11`, and verification documentation `304140d38546efc0c4a799b9d5fa8a5c96578929` are pushed. Achievement automation now covers every category VieriCodex directly executed: exact ordinary quests through stock Questionable, class/Grand Company Hunting Logs through the bounded Nexus hunt engine, world exploration, and flying unlocks. Supported Atlas entries expose direct Pursue actions; manual, group, crafting, gathering, PvP, collection, duty-finder-only, and time-gated entries remain clearly guided. All 351 Nexus tests, the zero-warning incremental Release build, five-module verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The packaging rebuild has only the known embedded-upstream warnings and zero errors. Release deployment `dpl_FBUaeSPrc2aHZa2ggHriqtb8TgW6` and final documentation deployment `dpl_GNgQx6zMpnmsXDgqtSj4ZKH4bcnK` are Ready. Runtime/source SHA-256: `617C29031B1EB6189F865EAF0D22A721B9BFBB64865A510EC5AA61C0465D3054` / `A4D2D555EFBBE8EF1BC0255D04C3DB78AB8A454061A776ECE4350AA3813FA422`. Discord workflow `34807867251` succeeded.

Verification evidence for 0.1.0.77: source `6d09526414a4614166f36385e633c883b8bf400a`, Daily Pilcrow release `008f9ce844d0ff0aac3cdb4388627bc7bba4555b`, and verification documentation `31dfe6e74a0868e77027d67ea69f6b70582967c7` are pushed. Complete VieriAutoMarket, VieriDelvUI, VieriLink, and VieriAvarice settings are rendered inside their Nexus destinations; Combat/Rotation no longer omits positional guidance; Automation can open stock Questionable's native tools directly. `VieriFeatureParity` makes the Vieri products the permanent behavioral baseline, explicitly assigns custom behavior to Nexus or its embedded runtimes, and keeps ordinary quest, duty, rotation, teleport, and mesh execution in updateable stock providers. The exact VieriAutoDuty Goto/Gear/Inventory/Extras action surface is regression-locked. All 370 Nexus tests, 16 embedded DelvUI tests, 21 embedded VieriLink tests, the complete Release build, five-module verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The packaging rebuild has only inherited embedded-library warnings and zero errors. Release deployment `dpl_DJWmac5MS4V3XKLesnQPFtAVfhW3` and final documentation deployment `dpl_GqHz2nU2LatCGn5inm9GomBoyCvz` are Ready. Runtime/source SHA-256: `E2A12B8D43F5960436889F6C3D8885F445E1FBB73C53BCC6DEAF8009E3FB100B` / `2004873CD9BA9BBFCFAB720581DB59B555145E394C24B7229AAB76BF0246ABC9`. Discord workflow `35484278454` succeeded. Historical untracked archives and `rustdesk-1.4.9-x86_64.exe` remain untouched. This release establishes and exposes the broad parity surface but does not declare the consolidation complete; richer VieriCodex-style Progress Atlas expansion/category drill-down remains the next production slice.

Verification evidence for 0.1.0.78: source `2d483f7ab8a5424ecc9b8d7caa8400b7aae85205`, Daily Pilcrow release `70a1a67412648f804eb80582529ed8c6be4bf1da`, and verification documentation `c6c9941b42f56eee58ab883e2fb63581f05775c2` are pushed. Progress Atlas is expansion-first and includes MSQ, current-job Class/Job/Role quests, Side Quests, Aetherytes/Aethernet, field and quest Aether Currents, world and duty exploration, and categorized duty unlocks. Nexus owns the unified presentation and safety boundary; stock Questionable provides live quest status and exact execution, and stock AutoDuty receives only duties with a confirmed path. Current game data connects duties to exact unlock quests where possible. Per-frame observation budgeting and caching protect Dalamud's draw loop. All 381 Nexus tests, the zero-warning incremental Release build, five-module verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The publisher rebuild has only inherited embedded-library warnings and zero errors. Release deployment `dpl_E9WP7U4pmEHmthidcmSna7omM8sQ` and final documentation deployment `dpl_6ruZTksJVCiTTdqX5mMvVnKGkGZK` are Ready. Runtime/source SHA-256: `5FC43A1F8C6D8BBD3857422229B5E7BE8D027725F5AB7371120BADC46E9121A2` / `9C75CA71C0DBD223E095F8AE6EB920D44F8B0C3A622FA1548D5784AE332A22FF`. Discord workflow `35485097391` succeeded. Historical untracked archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.79: source `6bc0e58befe1379776d82e0353f3c2e47898cd65`, Daily Pilcrow release `98ed75c5c47f8f69c3aa7ba8dfcebbf2febf9ddf`, and verification documentation `9cb796389e7aa3a0b1c9831f02c95415a78100d6` are pushed. Custom Route Editor now exposes VieriCodex-style One Click Navigation with Arm Next Map Click, Go to Current Flag, optional shortcut capture, destination/status presentation, and Stop. Same-zone and cross-zone destinations use the normal Nexus coordinator over stock Lifestream and vnavmesh; destination height is resolved against the loaded target mesh only after the territory transition. The compact operations overlay's Flag Marker action shares the same implementation and no longer rejects other territories. All 384 Nexus tests, 16 embedded DelvUI tests, 21 embedded VieriLink tests, the zero-warning incremental Release build, five-module verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The publisher rebuild has only inherited embedded-library warnings and zero errors. Release deployment `dpl_G5H2tVYgRzs6iLvK7eyjzVRjDgs3` and final documentation deployment `dpl_BqdaXi9HjCybzwDTAmrBgAJAnuxk` are Ready. Runtime/source SHA-256: `253D70239264103AB3A4B8B5FF0EE4E636603DBAF11240EC1C6BE6F585FA98F3` / `EBB9E9C25937D0E0D75B56F97070A2D252ACF0EE66B6A1DC7D8D5279277A562A`. Discord workflow `35485984942` succeeded. Historical untracked archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.80: source `59932ad2395f653f57967f66df63be315f20d2d2`, Daily Pilcrow release `596c941edeb8588749627da7eb9b99a50c118ed4`, and verification documentation `4b064e02d6215575ec1a4f166bcafe46b22b865c` are pushed. The VieriCodex transactional importer now carries the complete One Click Navigation shortcut—enabled state, key, Ctrl/Shift/Alt modifiers, and exact-modifier behavior—into Nexus. Fresh setup applies it with Progression and Atlas preferences, already-activated imports receive a one-time automatic promotion, and rollback restores the exact pre-import Nexus shortcut. All 384 Nexus tests, 16 embedded DelvUI tests, 21 embedded VieriLink tests, the Release build, five-module verifier, all 205 website tests, typecheck, the 13-entry inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The publisher rebuild has only inherited embedded-library warnings and zero errors. Release deployment `dpl_tqbV7g2Twf2nHBEuqMEc4JLDNK4A` and final documentation deployment `dpl_5L74qWTdvxqL4YhzMwonY4nD4gyz` are Ready. Runtime/source SHA-256: `ECC32D24FC9BE992822763639A7D82C682C72FB44224AC6108D0350907312BE8` / `B7C988A3B2222E3F8FB2C37341BCE8C71F92AE6396BF4859A4AD281109B472EB`. Discord workflow `35486765981` succeeded. Historical untracked archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.81: source `f38bdadcc341f998b77cafdd87bea0f2d0a3c740`, Daily Pilcrow release `17ee74f4403770fac47756860bcbe67e42782f5a`, and verification documentation `d62c70161fe5d2b71ead6d7d23d6cb35d2f727a3` are pushed. Every cross-zone saved route and One Click Navigation request now ranks current unlocked Aetherytes and Aethernet shards against the actual target coordinate instead of choosing the first game-data row. Locked endpoints are excluded, a shard requires an unlocked network hub, and missing map coordinates use a deterministic fallback. Nexus owns arrival selection while stock Lifestream and vnavmesh remain the replaceable mechanics providers. All 388 Nexus tests, 16 embedded DelvUI tests, 21 embedded VieriLink tests, the zero-warning Release build, five-module verifier, all 205 website tests, typecheck, the 13-entry inventory guard, production build, focused local/live validation, and public HTTP/ZIP/hash checks pass. The publisher rebuild has only inherited embedded-library warnings and zero errors. Release deployment `dpl_Br3JoDHyCKy5Kby4gk9Wz7aBw71g` and final documentation deployment `dpl_4YUMe5qefDa29STCH83Yktq9iNkW` are Ready. Runtime/source SHA-256: `8349EE363A7767F9CB9E3234516DF0F08A39245F680435AD986284C8800A9EB6` / `F3B38BBA18B1D04ABEDEA5F7BF7EE41FDD7BB907515987B15359C6A210DFEA30`. Discord workflow `35488849643` succeeded. Historical untracked archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.84: source `21726a8563b0581df0fba3b52cf1f53cd08d49cc` and Daily Pilcrow release `0300ef92c81d8a89ebc47fb43f09e2c6202c7897` are pushed. Nexus preserves the complete imported VieriAutoDuty maintenance sequence around stock AutoDuty, honors the automatic-buy, automatic-equip, repair-threshold, filter, vendor, and return controls, and keeps its predecessor-compatible compact overlay. Short vendor approaches now remain on the ground and a stalled flight-path calculation is cancelled after fifteen seconds and retried once on the ground, correcting the shared manual-shopping and duty-preflight stall. The detailed VieriCodex-style Progress Atlas and Hunting Log requirements/actions are restored while stock Questionable remains the ordinary quest provider. All 396 Nexus tests, the zero-warning Nexus Release build, five-module package verifier, all 205 website tests, typecheck, inventory guard, production build, and focused local/live archive validation pass. The publisher rebuild has only inherited embedded-library warnings and zero errors. Production deployment `dpl_FbYmy2B8ssoZmivihYfb2ksbUqCa` is Ready; runtime/source SHA-256 are `2DEB8C60FFF13D2C4A05AEFFA9F459E1D4B49B80B500F2F94F4563D010537EA6` / `5BD78A968F9491BF059159F0247DA03F69953A1C2BA05F496FB4A3DA4255E2E4`; Discord workflow `35508620540` succeeded. Historical unrelated archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.85: source `38b24637b0252356805f6863e503010637972334` and Daily Pilcrow release `54f212d149c29fce13c811d4a126cc1db10712e9` are pushed. Gear -> Shop for Upgrades again performs the full predecessor interaction directly from the compact overlay: immediate scan, recommended selection, detailed current/replacement rows, active-EXP protection, imported gil reserve, cost estimate, refresh and selection controls, Start Shopping, and Cancel. It no longer opens the Gear & Inventory page. All 396 Nexus tests, the zero-warning Nexus Release build, five-module package verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live archive validation, and Discord workflow `35509165097` pass. Production deployment `dpl_8QJp49QyYeznohmBaxXLxMfpsipr` is Ready; runtime/source SHA-256 are `CD84EDA38F9D81A6DAC745B1153669AB993DD4C7617EA6F2A8C442E29DF8CD5F` / `C9AA1118C9B2087A262665E468D45C19CAC619FD4D189F9715FF0CE2C748EFF6`. Historical unrelated archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.

Verification evidence for 0.1.0.86: source `49a710ba55b362890d8c12436fb3e052b6d54a87` and Daily Pilcrow release `a4c8a971deb6f135be9fc2a9424da973892716e7` are pushed. Gear -> Shop for Upgrades is again a true one-click compact-overlay action: the click performs the fresh scan, selects only strict recommended replacements, protects active EXP equipment, enforces the imported per-character gil reserve, and immediately starts the corrected Nexus-owned shopping transaction. It opens no Nexus page, review list, modal, or second Start Shopping confirmation. All 396 Nexus tests, the zero-warning Nexus Release build, five-module package verifier, all 205 website tests, typecheck, inventory guard, production build, focused local/live archive validation, and Discord workflow `35510213572` pass. Production deployment `dpl_C2esiUPyVopyRNXkXSQRWKZfS7BM` is Ready; runtime/source SHA-256 are `DAD8C428508A4B6B1C8BC8AC89603177545759D838AEE6B99D1EF912523F70E0` / `A9B23037546ADCDA995C470604BC49848C106F11322D3618CD3D612AC453FCA4`. Historical unrelated archives and `rustdesk-1.4.9-x86_64.exe` remain untouched.
