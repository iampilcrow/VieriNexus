...
Current product version: `0.1.0.53` release candidate
...
The 0.1.0.53 release candidate passes all 291 tests plus a zero-warning full plugin build. The currently published 0.1.0.52 source remains the live fallback until packaging and public verification complete.
...
- Plugin project version: `0.1.0.53` release candidate. Dalamud API 15. Version 0.1.0.52 remains published through the production feed until the 0.1.0.53 release checks complete.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
