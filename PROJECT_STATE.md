...
Current published source: `0.1.0.54`, release source `94830490db7213081af3d5513ef807a7ef6f41a1`, website release `0d120b563d43dcc31805de15dbda7e5255b008ff`; version 0.1.0.55 is locally verified and awaiting publication. The unrelated untracked `rustdesk-1.4.9-x86_64.exe` remains untouched.
Current workstream: version 0.1.0.55 rebuilds the former Command Center as the Plugins page, matching the actual VieriDeck-replacement purpose. Dalamud Plugins and Dalamud Settings are top actions; favorites render above all remaining plugins; and Show/Hide Commands expands immediately beneath the clicked plugin instead of appearing out of sight after the complete list. Existing VieriDeck imports, working settings, old selected-page state, and `/nexus commands` remain compatible. Version 0.1.0.54 remains the current live release until this package completes the established publication checks. Separately, stock AutoDuty 0.0.0.335's only remaining generic recovery difference is isolated with five passing policy tests on branch `nexus-recovery-fixes-0.0.0.335` at `2c583870c216573a054af109d11fafdd85d556be`.
...
The published 0.1.0.54 source passes all 292 tests plus a zero-warning full plugin build.
...
- Plugin project version: `0.1.0.55`. Dalamud API 15. Version 0.1.0.54 remains published through the production feed while 0.1.0.55 completes publication.
- Production Dalamud custom-repository URL: `https://www.thedailypilcrow.com/dalamud/pluginmaster.json`.
