...
internal static class BuiltInModuleCatalog
{
    internal static ModuleRegistry Create()
    {
        ...
        Register(registry, "combat", "Combat/Rotation", "Rotation engine, controls, suggestions, and positional guidance.", "Automation", "vieri.capability.combat.control/v1");
        ...
        Register(registry, "market", "Market Helper", "Retainer scans, pricing decisions, and verified adjustments.", "Economy", "vieri.capability.market.reprice/v1");
        ...
        Register(registry, "navigation", "Custom Route Editor", "Named route recording, manual plotting, world previews, playback, and reusable automation assignments.", "Automation", "vieri.capability.navigation.route/v1");
        return registry;
    }
