...
internal class PositionalDebugWindow : Window
{
    ...
    public override void Draw()
    {
        ...
        ImGuiEx.TextWrapped("Compare known hits and misses with the Verdict column. Unknown means the result is not covered by the verified table (or no damage was reported); it does not trigger MISS feedback or affect hit/miss statistics. param2 marked with * matched a hit row. Use Copy export to share raw values.");
        ImGui.Separator();
