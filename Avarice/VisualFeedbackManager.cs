...
internal class VisualFeedbackOverlay : Window
{
    ...
    {
        return IsShowingFeedback && P.GameplayOverlaysReady;
    }
    ...
    public override void Draw()
    {
        ...
        {
            var boundsSize = new Vector2(settings.IconSize * 2.4f);
            if (NativeUiOcclusion.IsCovered(screenPos - boundsSize / 2f, boundsSize)) return;
        }
