...
namespace DelvUI.Helpers
{
    internal static class Utils
    {
        ...
        {
            // Duty Support and Trust actors are not guaranteed to occupy the even
            // actor slots used by the owner/companion layout. Check every live slot
            // so NPC party members are not silently skipped.
