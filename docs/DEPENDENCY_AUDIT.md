...
- Questionable 15.756.2.4 is incorporated through VieriCodex 1.12.2.81 at source commit `1bc749b1e6f04519608b04caaca21c882e28412f` (upstream tag commit `f1b6da5ee5a9509c2f955f1fa93e73d5bfc4ffb8`). It adds current quest/gathering routes, the missing Kugane side-quest set, standardized IPC health adapters, interaction-wait combat handling, class-switch safeguards, and Aetheryte/Unlocks journal improvements while retaining the Vieri live-gearset guard, Progress Atlas, Progression Queue, named routes, and solo-duty safeguards. See `QUESTIONABLE_PROVIDER_MIGRATION_AUDIT.md`.
