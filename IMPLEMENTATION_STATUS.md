...
- Source provenance now includes VieriAutoDuty 1.0.0.429 and VieriNavPlotter 1.0.0.11, preserving the complete manual Shop for Upgrades transaction, validated route playback, explicit visualization ownership, and hidden ordinary Goto/dungeon navigation. Distinct authored standing points always finish before interaction eligibility can end travel; raw NPC-coordinate routes retain native early stopping. Measured standing points are preserved separately from NPC coordinates for Geraint; the three Limsa gear vendors Iron Thunder `-155.3658, 18.2000, 23.3950`, Faezghim `-236.5439, 16.2000, 40.3006`, and Sorcha `-135.1727, 18.2000, 14.8682`; and the three Ishgard gear vendors Seghuie `-189.1842, -12.6349, -40.0551`, Elbert `-216.0509, -16.1262, -60.4229`, and Norlaise `-205.2957, -16.1349, -51.2569`.
